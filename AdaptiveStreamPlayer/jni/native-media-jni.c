 ...
 *
 *   src/com/example/adaptivestreamplayer/CustomPlayActivity/CustomPlayActivity.java
 *
...
static pthread_mutex_t mutexNextFile = PTHREAD_MUTEX_INITIALIZER;
...
void Java_com_example_adaptivestreamplayer_CustomPlayActivity_createEngine(JNIEnv* env, jclass clazz)
{
    XAresult res;
...
jboolean Java_com_example_adaptivestreamplayer_CustomPlayActivity_createStreamingMediaPlayer(JNIEnv* env,
...
void Java_com_example_adaptivestreamplayer_CustomPlayActivity_setPlayingStreamingMediaPlayer(JNIEnv* env,
...
void Java_com_example_adaptivestreamplayer_CustomPlayActivity_shutdown(JNIEnv* env, jclass clazz)
{
...
// set the surface
void Java_com_example_adaptivestreamplayer_CustomPlayActivity_setSurface(JNIEnv *env, jclass clazz, jobject surface)
{
...
void Java_com_example_adaptivestreamplayer_CustomPlayActivity_rewindStreamingMediaPlayer(JNIEnv *env, jclass clazz)
{
    XAresult res;
